...
export const parseArchivePost = (data: RawArchivePost) => {
  ...
  const thread =
    g.threads.get(`${o.boardID}.${o.threadID}`) || new Thread(o.threadID, board)
